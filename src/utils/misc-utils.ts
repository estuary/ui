...
export const MARKETING_DEMO_TENANT = 'Artificial-Industries/'; // This is like the demo tenant but one we do not want to always share with every user that signs up
