...
export const Workflows: Record<string, string> = {
    ...
    'workflows.collectionSelector.schemaInference.message': `${CommonMessages.productName} can help you tighten your collection specification. It will review the documents in a collection and approximate the shape of your data.`,
    ...
    'destinationLayout.dialog.schema.useTemplate': `Schema : provide prefix/suffix`,
    'destinationLayout.dialog.schema.useFixed': `Use fixed schema name`,
    'destinationLayout.dialog.table.label': `Table`,
    'destinationLayout.dialog.table.useTemplate': `Table : provide prefix/suffix`,
