...
export const Workflows: Record<string, string> = {
    ...
    'entityCreate.bindingsConfig.noRowsTitle.capture': `No bindings found`,
    'entityCreate.bindingsConfig.noRows.capture': `No bindings were discovered for this capture, please check your credentials`,
