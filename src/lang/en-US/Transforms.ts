...
export const Transforms: Record<string, string> = {
    ...
    'newTransform.steps.1.learnMore': `See how to {docLink} our CLI tool.`,
    'newTransform.steps.1.learnMore.docLink': `install`,
    'newTransform.steps.1.learnMore.docPath': `https://docs.estuary.dev/concepts/flowctl/#installation-and-setup`,

    'newTransform.steps.2': `Authenticate your account`,
    'newTransform.steps.2.code': `flowctl auth login`,
    'newTransform.steps.2.learnMore': `Opens the ${CommonMessages['productName']} Dashboard. Paste the displayed access token into the terminal to {docLink}.`,
    'newTransform.steps.2.learnMore.docLink': `authenticate`,
    'newTransform.steps.2.learnMore.docPath': `https://docs.estuary.dev/reference/authentication/#authenticating-flow-using-the-cli`,

    'newTransform.steps.3': `Select created draft`,
    'newTransform.steps.3.code': `flowctl draft select --id {draftId}`,
    'newTransform.steps.3.learnMore': `Sets your derivation as your active {docLink}.`,
    'newTransform.steps.3.learnMore.docLink': `draft`,
    'newTransform.steps.3.learnMore.docPath': `https://docs.estuary.dev/guides/flowctl/edit-draft-from-webapp/#identify-the-draft-and-pull-it-locally`,
    ...
    'newTransform.steps.5.learnMore': `Learn more about constructing {docLink}.`,
    'newTransform.steps.5.learnMore.docLink': `derivations`,
    'newTransform.steps.5.learnMore.docPath': `https://docs.estuary.dev/concepts/derivations/`,
