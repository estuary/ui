...
export const Authentication: Record<string, string> = {
    ...
    'tenant.warningMessage.problematic': `Looks like your organization name contains "test". This is generally not recommended as you cannot rename your organization.`,
