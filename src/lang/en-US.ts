...
const Workflows: ResolvedIntlConfig['messages'] = {
    ...
    'workflows.collectionSelector.error.message.invalidPubId': `Changes to this collection were published. The latest drafted record of the collection can be found in the editor.`,
    'workflows.collectionSelector.error.message.draftCreationFailed': `There was an issue creating a new draft to edit. The latest published record of the collection can be found in the editor. It is read-only.`,
