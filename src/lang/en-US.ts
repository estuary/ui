...
const SchemaEditor_Collection: ResolvedIntlConfig['messages'] = {
    ...
    'schemaEditor.table.filter.label': `Filter to`,
    'schemaEditor.table.filter.option.all': `show all fields`,
    'schemaEditor.table.filter.option.must': `show fields that always exist`,
    'schemaEditor.table.filter.option.may': `show fields that sometimes exist`,
