...
const NewTransform: ResolvedIntlConfig['messages'] = {
    ...
    'newTransform.catalog.header': `Configuration`,
    ...
    'newTransform.catalog.tab.basicSettings': `General`,
    'newTransform.editor.catalog.advancedSettings': `Advanced Configuration`,
    'newTransform.editor.catalog.transform.header': `Transforms`,
    'newTransform.editor.catalog.transform.addDialog.header': `Add Transform`,
