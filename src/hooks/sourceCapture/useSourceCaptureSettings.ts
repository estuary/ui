...
export default function useSourceCaptureSettings() {
    // Draft Editor Store
    ...
    return {
        current: draftSpec?.spec?.source ? draftSpec.spec.source : {},
