...
import { getSearchLabel } from 'src/components/shared/Entity/Details/Overview/Bindings/shared';
...
export function BindingsCard({
    ...
    return (
        <CardWrapper
            ...
            disableMinWidth
            // CardWrapper only borders itself in light mode; the dark-mode
            // tonal wash is too faint to contain a dense table.
            sx={{
