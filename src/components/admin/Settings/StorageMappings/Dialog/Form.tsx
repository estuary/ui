...
// TODO (storageMappings): Create a hook, akin to the useXColumns hooks, which exports both the schema and uischema.
...
function StorageMappingForm() {
    ...
    // TODO (storageMappings): Generate the uischema only once in the new form schema hook.
