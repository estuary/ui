...
**Option A - Web UI:** Navigate to the **Permissions** tab and paste this into your bucket policy.

```
{{bucketPolicy}}
```

> This policy includes all data planes that use the bucket, so existing connections will be preserved.
