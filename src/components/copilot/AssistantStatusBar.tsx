...
// terminal absorbed the old top bar's chrome (entity health strip, update
// alert), so turning the chat off shouldn't take those with it — this is the
// same top-right cluster in a slim, static bar.
