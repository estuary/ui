...
export type QueryRoot = {
   ...
   * `QueryServiceAccounts`, optionally narrowed to those an organization
   * reaches with `filter.tenant`.
   */
...
export type QueryRootServiceAccountsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  filter?: InputMaybe<ServiceAccountsFilter>;
  first?: InputMaybe<Scalars['Int']['input']>;
};
 ...
 * independently, so a filter can never widen what a caller may see.
 */
export type ServiceAccountsFilter = {
  /**
   * Keep only accounts whose `catalogName` lies under a prefix this tenant
   * reaches through the role-grant graph — the tenant's own namespace, plus
   * any namespace a chain of role grants projects it into.
   *
   * The reachable set is intersected with the caller's own authorized
   * prefixes, so this narrows a listing to one organization's accounts and
   * never surfaces an account the caller could not already see. Asking what
   * a tenant reaches requires `read` on that tenant.
   */
  tenant?: InputMaybe<Scalars['Prefix']['input']>;
};
...
export type CreateAlertSubscriptionMutationMutationVariables = Exact<{
  prefix: Scalars['Prefix']['input'];
  email: Scalars['String']['input'];
  alertTypes?: InputMaybe<Array<AlertType> | AlertType>;
  detail?: InputMaybe<Scalars['String']['input']>;
}>;
...
export type ServiceAccountFieldsFragment = { __typename?: 'ServiceAccount', catalogName: string, createdAt: string, createdByEmail?: string | null, lastUsedAt?: string | null, grants: Array<{ __typename?: 'UserGrant', prefix: string, capability: Capability, createdAt: string, detail?: string | null, updatedAt: string }>, apiKeys: Array<{ __typename?: 'ServiceAccountApiKey', id: string, detail?: string | null, createdAt: string, createdByEmail?: string | null, expiresAt: string, lastUsedAt?: string | null }> };
...
export type ServiceAccountsQuery = { __typename?: 'QueryRoot', serviceAccounts: { __typename?: 'ServiceAccountConnection', edges: Array<{ __typename?: 'ServiceAccountEdge', node: { __typename?: 'ServiceAccount', catalogName: string, createdAt: string, createdByEmail?: string | null, lastUsedAt?: string | null, grants: Array<{ __typename?: 'UserGrant', prefix: string, capability: Capability, createdAt: string, detail?: string | null, updatedAt: string }>, apiKeys: Array<{ __typename?: 'ServiceAccountApiKey', id: string, detail?: string | null, createdAt: string, createdByEmail?: string | null, expiresAt: string, lastUsedAt?: string | null }> } }> } };

export type CreateServiceAccountMutationVariables = Exact<{
  catalogName: Scalars['Name']['input'];
  grants: Array<UserGrantInput> | UserGrantInput;
}>;


export type CreateServiceAccountMutation = { __typename?: 'MutationRoot', createServiceAccount: { __typename?: 'ServiceAccount', catalogName: string, createdAt: string } };
...
export type CreateApiKeyMutation = { __typename?: 'MutationRoot', createApiKey: { __typename?: 'CreateApiKeyResult', id: string, secret: any, serviceAccount: { __typename?: 'ServiceAccount', catalogName: string, createdAt: string, createdByEmail?: string | null, lastUsedAt?: string | null, grants: Array<{ __typename?: 'UserGrant', prefix: string, capability: Capability, createdAt: string, detail?: string | null, updatedAt: string }>, apiKeys: Array<{ __typename?: 'ServiceAccountApiKey', id: string, detail?: string | null, createdAt: string, createdByEmail?: string | null, expiresAt: string, lastUsedAt?: string | null }> } } };
...
export type RevokeApiKeyMutation = { __typename?: 'MutationRoot', revokeApiKey: { __typename?: 'ServiceAccount', catalogName: string, createdAt: string, createdByEmail?: string | null, lastUsedAt?: string | null, grants: Array<{ __typename?: 'UserGrant', prefix: string, capability: Capability, createdAt: string, detail?: string | null, updatedAt: string }>, apiKeys: Array<{ __typename?: 'ServiceAccountApiKey', id: string, detail?: string | null, createdAt: string, createdByEmail?: string | null, expiresAt: string, lastUsedAt?: string | null }> } };
...
export type AddServiceAccountGrantMutation = { __typename?: 'MutationRoot', addServiceAccountGrant: { __typename?: 'ServiceAccount', catalogName: string, createdAt: string, createdByEmail?: string | null, lastUsedAt?: string | null, grants: Array<{ __typename?: 'UserGrant', prefix: string, capability: Capability, createdAt: string, detail?: string | null, updatedAt: string }>, apiKeys: Array<{ __typename?: 'ServiceAccountApiKey', id: string, detail?: string | null, createdAt: string, createdByEmail?: string | null, expiresAt: string, lastUsedAt?: string | null }> } };
...
export type RemoveServiceAccountGrantMutation = { __typename?: 'MutationRoot', removeServiceAccountGrant: { __typename?: 'ServiceAccount', catalogName: string, createdAt: string, createdByEmail?: string | null, lastUsedAt?: string | null, grants: Array<{ __typename?: 'UserGrant', prefix: string, capability: Capability, createdAt: string, detail?: string | null, updatedAt: string }>, apiKeys: Array<{ __typename?: 'ServiceAccountApiKey', id: string, detail?: string | null, createdAt: string, createdByEmail?: string | null, expiresAt: string, lastUsedAt?: string | null }> } };

export type RevokeAllApiKeysMutationVariables = Exact<{
  catalogName: Scalars['Name']['input'];
}>;


export type RevokeAllApiKeysMutation = { __typename?: 'MutationRoot', revokeAllApiKeys: { __typename?: 'ServiceAccount', catalogName: string, createdAt: string, createdByEmail?: string | null, lastUsedAt?: string | null, grants: Array<{ __typename?: 'UserGrant', prefix: string, capability: Capability, createdAt: string, detail?: string | null, updatedAt: string }>, apiKeys: Array<{ __typename?: 'ServiceAccountApiKey', id: string, detail?: string | null, createdAt: string, createdByEmail?: string | null, expiresAt: string, lastUsedAt?: string | null }> } };
